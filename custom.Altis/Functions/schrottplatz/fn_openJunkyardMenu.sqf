...
_header ctrlSetText "Schrottplatz";
_list ctrlSetEventHandler ["LBSelChanged", "[] call life_fnc_JunkyardLBChange"];
_buyBtn ctrlSetText "Reparieren";
_buyBtn buttonSetAction "[] spawn life_fnc_JunkyardBuy";
_sellBtn ctrlShow false;
_updateBtn buttonSetAction "[] call life_fnc_JunkyardUpdate";