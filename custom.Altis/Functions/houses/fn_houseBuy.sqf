...
if((_houseType && _gangName == "") || (_houseType && _gangBank < _housePrice) || (_houseType && _countGangHouses >= 1) || (_houseType && !_leader)) exitWith {["Du erfüllst die Bedingungen für einen Hauskauf nicht. Denke daran dass du das Geld auf deinem Konto haben musst!", "Haus kaufen"] spawn life_fnc_message;};
