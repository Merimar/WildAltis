...
SCHILD_DEALER addAction["<t color='#FF0000'>Gang Eroberung</t>",life_fnc_gangeroberung,"",0,false,false,"",'playerSide in [civilian, east] && isNull objectParent player && !life_action_inUse && SCHILD_DEALER getVariable["Zone_Dealer_Start",false]'];
