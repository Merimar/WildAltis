...
private _vehiclePriceWith = [_classname, _newSkin, _material, _insurance] call life_fnc_getVehiclePrice;
private _vehiclePriceWithout = [_classname, "-1", _material, _insurance] call life_fnc_getVehiclePrice;
...
[player, _classname, _id, _newSkin, _price, 0, _insurance, playerSide, _color, _material] remoteExec ["HC_fnc_applyLackierer", HC_LIFE];
closeDialog 0;
