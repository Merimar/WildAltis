...
if(isNull _group) exitWith {["Dieses Ganghideout ist bereits neutralisiert", "Nicht möglich"] spawn life_fnc_message;};
...
private _title = "Neutralisiere Ganghideout";
...
_marker setMarkerText _defaultText;

titleText["Du hast das Ganghideout neutralisiert", "PLAIN"];
["Die Polizei hat ein Ganghideout neutralisiert", "Gangversteck neutralisiert"] remoteExec ["life_fnc_message", -2];
