...
if("'" in (str _ausweis) || "{" in (str _ausweis) || "}" in (str _ausweis) || "toString" in (str _ausweis) || "tostring" in (str _ausweis) || "];" in (str _ausweis)) exitWith {diag_log format ["CONFIRM HACK: %1 (%2 - %3) - %4", name _unit, getPlayerUID _unit, side _unit, _this];};
