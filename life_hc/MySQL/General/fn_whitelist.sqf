...
[getPlayerUID _whitelistPlayer, _side, _what, _level] call HC_fnc_setSpecialLevel;
private _geheimZahl = [getPlayerUID _whitelistPlayer, side _whitelistPlayer] call HC_fnc_getGeheimzahl;
